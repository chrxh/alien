...
struct MODELINTERFACE_EXPORT CellChangeDescription
{
	uint64_t id = 0;
...
struct MODELINTERFACE_EXPORT ClusterChangeDescription
{
	uint64_t id = 0;
...
struct MODELINTERFACE_EXPORT ParticleChangeDescription
{
	uint64_t id = 0;
...
struct MODELINTERFACE_EXPORT DataChangeDescription
{
