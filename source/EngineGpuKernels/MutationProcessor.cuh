...
__inline__ __device__ void MutationProcessor::cellTypeMutation(SimulationData& data, Cell* cell)
{
    ...
    auto makeSelfCopy = cudaSimulationParameters.copyMutationSelfReplication.value ? data.numberGen1.randomBool() : false;
    ...
    auto targetGenome = data.objects.auxiliaryData.getRawSubArray(targetGenomeSize);
...
__inline__ __device__ void MutationProcessor::translateMutation(SimulationData& data, Cell* cell)
{
    ...
    auto targetGenome = data.objects.auxiliaryData.getRawSubArray(genomeSize);
