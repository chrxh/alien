...
__inline__ __device__ void MutationProcessor::applyRandomMutationsForCell(SimulationData& data, Cell* cell)
{
    ...
    auto cellCopyMutationGeometry = ZoneCalculator::calcParameter(
        ...
        &SimulationParametersZoneEnabledValues::copyMutationGeometry,
        data,
        cell->pos,
        cell->color) * numNodes;
    ...
    auto cellCopyMutationSubgenomeColor = ZoneCalculator::calcParameter(
        ...
        &SimulationParametersZoneEnabledValues::copyMutationSubgenomeColor,
        data,
        cell->pos,
        cell->color);
    auto cellCopyMutationGenomeColor = ZoneCalculator::calcParameter(
        &SimulationParametersZoneValues::copyMutationGenomeColor,
        &SimulationParametersZoneEnabledValues::copyMutationGenomeColor,
        data,
        cell->pos,
        cell->color);
...
__inline__ __device__ void MutationProcessor::neuronDataMutation(SimulationData& data, Cell* cell)
{
    ...
    auto cellCopyMutationNeuronData = ZoneCalculator::calcParameter(
        ...
        &SimulationParametersZoneEnabledValues::copyMutationNeuronData,
        data,
        cell->pos,
        cell->color);
...
__inline__ __device__ void MutationProcessor::propertiesMutation(SimulationData& data, Cell* cell)
{
    ...
    auto cellCopyMutationCellProperties = ZoneCalculator::calcParameter(
        ...
        &SimulationParametersZoneEnabledValues::copyMutationCellProperties,
        data,
        cell->pos,
        cell->color);
...
__inline__ __device__ void MutationProcessor::deleteMutation(SimulationData& data, Cell* cell)
{
    ...
    if (cudaSimulationParameters.expertToggles.customizeDeletionMutations
...
__inline__ __device__ void MutationProcessor::neuronDataMutationNode(SimulationData& data, uint8_t* genome, int nodeAddress)
{
    auto cellCopyMutationNeuronDataWeightsPercentage =
        cudaSimulationParameters.expertToggles.customizeNeuronMutations ? cudaSimulationParameters.cellCopyMutationNeuronDataWeight : 0.2f;
    auto cellCopyMutationNeuronDataBiasesPercentage =
        cudaSimulationParameters.expertToggles.customizeNeuronMutations ? cudaSimulationParameters.cellCopyMutationNeuronDataBias : 0.2f;
    auto cellCopyMutationNeuronDataActivationFunctionPercentage = cudaSimulationParameters.expertToggles.customizeNeuronMutations
        ? cudaSimulationParameters.cellCopyMutationNeuronDataActivationFunction
        : 0.05f;
    auto cellCopyMutationNeuronDataReinforcement =
        cudaSimulationParameters.expertToggles.customizeNeuronMutations ? cudaSimulationParameters.cellCopyMutationNeuronDataReinforcement : 1.05f;
    auto cellCopyMutationNeuronDataDamping =
        cudaSimulationParameters.expertToggles.customizeNeuronMutations ? cudaSimulationParameters.cellCopyMutationNeuronDataDamping : 1.05f;
    auto cellCopyMutationNeuronDataOffset =
        cudaSimulationParameters.expertToggles.customizeNeuronMutations ? cudaSimulationParameters.cellCopyMutationNeuronDataOffset : 0.05f;
    ...
    for (int i = Const::NeuronWeightAndBiasBytes; i < Const::NeuronBytes; ++i) {
        if (data.numberGen1.random() < cellCopyMutationNeuronDataActivationFunctionPercentage) {
            genome[nodeAddress + Const::CellBasicBytesWithoutNeurons + i] = data.numberGen1.randomByte();
        }
    }
}
...
__inline__ __device__ void MutationProcessor::propertiesMutationNode(SimulationData& data, uint8_t* genome, int genomeSize, int nodeAddress, int prevNodeAddress)
{
    ...
    if (data.numberGen1.randomBool()) {
        if (data.numberGen1.randomBool()) {
            ...
            auto randomDelta = data.numberGen1.random(Const::CellBasicBytesWithoutNeurons - 1);
            auto randomByte = data.numberGen1.randomByte();
