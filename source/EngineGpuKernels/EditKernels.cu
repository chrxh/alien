...
namespace
{
    ...
    __global__ void processConnectionChanges(SimulationData data) { CellConnectionProcessor::processConnectionsOperations(data); }
    ...
    __global__ void updateAngleAndAngularVelForSelection(ShallowUpdateSelectionData updateData, SimulationData data, float2 center)
    {
...
__global__ void cudaSwitchSelection(PointSelectionData switchData, SimulationData data)
{
    ...
    *result = 0;
    ...
    if (0 == *result) {
        ...
        DEPRECATED_KERNEL_CALL_SYNC_1_1(cudaRolloutSelection, data);
    }
