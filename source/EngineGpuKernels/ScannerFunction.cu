...
__device__ void ScannerFunction::processing(Token* token, SimulationData& data)
{
...
__device__ auto ScannerFunction::spiralLookupAlgorithm(int depth, Cell* cell, Cell* sourceCell, SimulationData& data) -> SpiralLookupResult
{
