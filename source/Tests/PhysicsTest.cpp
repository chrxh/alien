...
TEST_F(PhysicsTest, testAngleOfVector)
{
	...
	ASSERT_PRED2(predEqual_lowPrecision, 0.0, a);
    a = Physics::angleOfVector(QVector2D(1.0, 0.0));
	ASSERT_PRED2(predEqual_lowPrecision, 90.0, a);
    a = Physics::angleOfVector(QVector2D(0.0, 1.0));
	ASSERT_PRED2(predEqual_lowPrecision, 180.0, a);
    a = Physics::angleOfVector(QVector2D(-1.0, 0.0));
	ASSERT_PRED2(predEqual_lowPrecision, 270.0, a);
}
