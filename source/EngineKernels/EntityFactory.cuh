...
__inline__ __device__ Genome* EntityFactory::createGenomeFromTO(TOs const& to, int genomeIndex)
{
    ...
    genome->mutationRates.customizationMutation = {genomeTO.mutationRates.customizationMutation.genomeProbability};
    ...
    genome->mutationRates.swapGeneMutation = {genomeTO.mutationRates.swapGeneMutation.geneProbability};
