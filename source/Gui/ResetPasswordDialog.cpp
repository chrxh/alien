...
_ResetPasswordDialog::_ResetPasswordDialog(NewPasswordDialog const& newPasswordDialog, NetworkService const& networkController)
...
{
    if (_networkService->resetPassword(_userName, _email)) {
