...
void _InspectionWindow::processCreatureProperties(ExtendedObjectDesc& extendedObject)
{
    ...
    inspectorText("Mutations (total)", std::to_string(creature._accumulatedMutationsInLineage));
    inspectorText("Mutations (in lineage)", std::to_string(creature._accumulatedMutations));
