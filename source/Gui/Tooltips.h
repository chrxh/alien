...
namespace Const
{
    std::string const NeuronTooltip = "This function equips the cell with a small network of 8 neurons with 8x8 configurable weights and 8 bias values. It "
    ...
    std::string const NerveTooltip = "By default, a nerve cell forwards activity states by receiving activity as input from connected cells (and summing it if "
    ...
    std::string const AttackerTooltip = "An attacker cell attacks surrounding cells from other cell networks (with different creature id) by stealing energy from "
    ...
    std::string const DefenderTooltip = "A defender cell does not need to be activated. Its presence reduces the strength of an enemy attack involving attacker "
                       "cells or extends the injection duration for injector cells.";

    std::string const CellFunctionTooltip = "Cells can possess a specific function that enables them to, for example, perceive their environment, process information, or "
    ...
    std::string const ColorTooltip =
        "On the one hand, the cell color can be used to define own types of cells that are subject to different rules. For this purpose, the "
    ...
    std::string const EnergyTooltip =
    ...
    std::string const ExecutionNumberTooltip =
    ...
    std::string const InputExecutionNumberTooltip =
    ...
    std::string const BlockOutputTooltip = "Activating this toggle, the cell's output can be locked, preventing any other cell from utilizing it as input.";

    std::string const RequiredConnectionsTooltip =
    ...
    std::string const TransmitterEnergyDistributionTooltip =
    ...
    std::string const ConstructorActivationModeTooltip =
    ...
    std::string const ConstructorIntervalTooltip =
    ...
    std::string const ConstructorAngle2Tooltip =
    ...
    std::string const SensorModeTooltip =
    ...
    std::string const SensorScanAngleTooltip =
        "The angle can be determined here in which direction the scanning process should take place. An angle of 0 means that the "
    ...
    std::string const SensorScanColorTooltip = "Specifies the color of the cells to search for.";

    std::string const SensorMinDensityTooltip =
    ...
    std::string const NerveGeneratePulsesTooltip = "If enabled, an activity pulse in channel #0 will be generated at regular time intervals.";

    std::string const NervePulseIntervalTooltip =
        "The intervals between two pulses can be set here. It is specified in cycles, which corresponds to 6 time steps each.";

    std::string const NerveAlternatingPulsesTooltip =
    ...
    std::string const NervePulsesPerPhase = "This value indicates the number of pulses until a sign changes in the generated activity.";

    std::string const AttackerEnergyDistributionTooltip =
    ...
    std::string const InjectorModeTooltip = ICON_FA_CHEVRON_RIGHT
    ...
    std::string const MuscleModeTooltip = ICON_FA_CHEVRON_RIGHT
    ...
    std::string const DefenderModeTooltip =
    ...
    std::string const GenomeSingleConstructionTooltip = "This determines whether the encoded cell network in the genome should be constructed by the corresponding "
