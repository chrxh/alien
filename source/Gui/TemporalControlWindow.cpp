...
void _TemporalControlWindow::processCreateFlashbackButton()
{
    ...
    AlienImGui::Tooltip("Create flashback: It saves the content of the current world to memory.");
    if (result) {
...
void _TemporalControlWindow::processLoadFlashbackButton()
{
    ...
    AlienImGui::Tooltip("Load flashback: It loads the saved world from memory.");
    if (result) {
