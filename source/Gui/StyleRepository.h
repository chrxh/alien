...
namespace Const
{
    ...
    ImColor const TreeNodeColor = ImColor::HSV(0.6f, 0.6f, 0.50f);
    ImColor const TreeNodeHoveredColor = ImColor::HSV(0.6f, 0.6f, 0.65f);
    ImColor const TreeNodeActiveColor = ImColor::HSV(0.6f, 0.6f, 0.75f);
