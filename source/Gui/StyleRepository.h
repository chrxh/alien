...
namespace Const
{
    ...
    ImColor const ParametersFeatureColor = ImColor::HSV(0.9f, 0.3f, 0.55f);
    ImColor const ParametersFeatureHoveredColor = ImColor::HSV(0.9f, 0.3f, 0.65f);
    ImColor const ParametersFeatureActiveColor = ImColor::HSV(0.9f, 0.3f, 0.75f);
}
