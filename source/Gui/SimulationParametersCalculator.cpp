...
SimulationParametersCalculator _SimulationParametersCalculator::createWithRandomTarget(SimulationParameters const& source)
{
    ...
    target.spotValues.cellFunctionWeaponColorPenalty = numberGenerator.getRandomFloat(0.0f, 1.0f);
...
SimulationParameters _SimulationParametersCalculator::calcCurrentParameters() const
{
    ...
    result.spotValues.cellFunctionWeaponColorPenalty =
        calcCurrentParameter(_source.spotValues.cellFunctionWeaponColorPenalty, _target.spotValues.cellFunctionWeaponColorPenalty);
