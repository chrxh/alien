...
void DescValidationService::validateAndCorrect(GenomeDesc& genome)
{
    ...
    genome._mutationRates._customizationMutation._genomeProbability =
        std::clamp(genome._mutationRates._customizationMutation._genomeProbability, 0.0f, 1.0f);
    ...
    genome._mutationRates._addGeneMutation._geneProbability = std::clamp(genome._mutationRates._addGeneMutation._geneProbability, 0.0f, 1.0f);
    ...
    genome._mutationRates._swapGeneMutation._geneProbability = std::clamp(genome._mutationRates._swapGeneMutation._geneProbability, 0.0f, 1.0f);
