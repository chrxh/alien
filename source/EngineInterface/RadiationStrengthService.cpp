...
auto RadiationStrengthService::getRadiationStrengths(SimulationParameters const& parameters) const -> RadiationStrengths
{
...
void RadiationStrengthService::applyRadiationStrengths(SimulationParameters& parameters, RadiationStrengths const& strengths) const
{
...
void RadiationStrengthService::adaptRadiationStrengths(RadiationStrengths& strengths, RadiationStrengths& origStrengths, int changeIndex) const
{
...
auto RadiationStrengthService::calcRadiationStrengthsForAddingSource(RadiationStrengths const& strengths) const -> RadiationStrengths
{
...
auto RadiationStrengthService::calcRadiationStrengthsForDeletingLayer(RadiationStrengths const& strengths, int deleteIndex) const -> RadiationStrengths
{
