...
struct std::hash<GenomeDesc>
{
    std::size_t operator()(GenomeDesc const& desc) const
    {
        ...
        hash_combine(seed, desc._mutationRates._customizationMutation._genomeProbability);
        ...
        hash_combine(seed, desc._mutationRates._swapGeneMutation._geneProbability);
