...
struct SimulationParameters
{
    ...
    float cellFunctionConstructorDataMutationProb = 0.0;
    float cellFunctionConstructorPropertyMutationProb = 0.0;    //*5
    float cellFunctionConstructorStructureMutationProb = 0.0;   //*15
