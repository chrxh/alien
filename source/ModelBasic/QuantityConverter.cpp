#include "QuantityConverter.h"

#include <QtCore/qmath.h>

qreal QuantityConverter::convertDataToAngle(quint8 b)
{
...
quint8 QuantityConverter::convertURealToData(qreal r)
{
	if (r < 0.0)
		return 0;
	if (r > 127.0)
...
qreal QuantityConverter::convertDataToUReal(quint8 d)
{
	return static_cast<qreal>(d);
}

quint8 QuantityConverter::convertIntToData(int i)
{
	if (i > 127)
		return i;
	if (i < -128)
