...
std::pair<CreatureDesc, GenomeDesc> DescTestDataFactory::createNonDefaultCreatureDesc(NodeParameter nodeParameter) const
{
    auto mutation = MutationRatesDesc()
                        ...
                        .customizationMutation(CustomizationMutationDesc().genomeProbability(0.23f))
                        ...
                        .addGeneMutation(AddGeneMutationDesc().geneProbability(0.49f))
                        ...
                        .swapGeneMutation(SwapGeneMutationDesc().geneProbability(0.50f))
