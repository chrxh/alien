...
TEST_F(ConstructorTests, DISABLED_insufficientSpace)
{
    ...
    data.addCreature(
        {
            ObjectDesc().id(1).pos({100.5f, 100.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(1),
        GenomeDesc().genes({
            GeneDesc().nodes({NodeDesc(), NodeDesc()}),
    ...
    auto data = ContentDesc().addCreature(
        {
            ...
            ObjectDesc().id(3).pos({10.0f, 10.0f + 1.8f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(2)),
            ObjectDesc().id(2).pos({9.0f, 9.0f + 1.8f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(1)),
            ObjectDesc().id(1).pos({11.0f, 9.0f + 1.8f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(0),
        genome);
...
TEST_P(ConstructorTests_AllNodeTypes, creature_1__node_0_1__concatenation_0_1__branch_0_0__gene_0)
{
    ...
    EXPECT_EQ(CellState_BeingActivated, newObject.getCellRef()._cellState);
...
TEST_F(ConstructorTests, creature_1__node_2_3__concatenation_0_1__branch_0_0__frontAngle_upperSide)
{
    ...
    auto data = ContentDesc()
                    ...
                    .addCreature(
                        {
                            ObjectDesc().id(2).pos({10.0f + getOffspringDistance(), 10.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(1)),
                            ObjectDesc().id(3).pos({10.0f + getOffspringDistance(), 9.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
                        },
                        CreatureDesc().id(1),
                        genome);
    ...
    EXPECT_EQ(CellState_BeingActivated, actualConstructedCell.getCellRef()._cellState);
    EXPECT_EQ(CellState_UnderConstruction, prevConstructedCell.getCellRef()._cellState);
    EXPECT_EQ(CellState_UnderConstruction, prevPrevConstructedCell.getCellRef()._cellState);
}
...
TEST_F(ConstructorTests, creature_1__node_2_3__concatenation_0_1__branch_0_0__frontAngle_lowerSide)
{
    ...
    auto data = ContentDesc()
                    ...
                    .addCreature(
                        {
                            ObjectDesc().id(2).pos({10.0f + getOffspringDistance(), 10.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(1)),
                            ObjectDesc().id(3).pos({10.0f + getOffspringDistance(), 11.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
                        },
                        CreatureDesc().id(1),
                        genome);
...
TEST_F(ConstructorTests, creature_1__node_0_2__concatenation_0_1__branch_0_1)
{
    ...
    auto hostObject = actualData.getObjectRef(0);
    auto newObject = actualData.getOtherObjectRef(0);
    EXPECT_EQ(CellState_UnderConstruction, newObject.getCellRef()._cellState);
    EXPECT_TRUE(newObject.getCellRef()._headCell);
    EXPECT_TRUE(approxCompare(0.5f, Math::length(hostObject._pos - newObject._pos)));
    ...
    auto data = ContentDesc().addCreature(
        {
            ...
            ObjectDesc()
                ...
                .type(CellDesc().cellType(MuscleDesc().mode(muscleMode)).cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(0),
        GenomeDesc().genes({
    ...
    auto data = ContentDesc().addCreature(
        {
            ObjectDesc()
                ...
                .pos({100.0f, 100.0f})
                .type(CellDesc().usableEnergy(getConstructorEnergy()).constructor(ConstructorDesc().geneIndex(0).separation(false).numBranches(2))),
            ObjectDesc().id(1).pos({100.0f, 101.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(0),
        genome);
    data.addConnection(0, 1);
...
TEST_F(ConstructorTests, creature_1__node_1_2__concatenation_0_1__branch_0_0)
{
    ...
    data.addCreature(
        {
            ObjectDesc().id(1).pos({99.0f, 100.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(1),
        GenomeDesc().genes({
            GeneDesc().nodes({NodeDesc(), NodeDesc()}),
...
TEST_F(ConstructorTests, creature_1__node_1_2__concatenation_0_1__branch_0_1)
{
    ...
    _simulationFacade->calcTimesteps(1);
    {
        auto actualData = _simulationFacade->getSimulationData();
        auto prevCell = actualData.getObjectRef(1);
        EXPECT_EQ(CellState_BeingActivated, prevCell.getCellRef()._cellState);
    }
}
...
TEST_F(ConstructorTests, creature_3__node_1_2__concatenation_0_1__branch_0_1)
{
    ...
    auto data = ContentDesc().addCreature(
        {
            ObjectDesc().id(0).pos({101.0f, 100.0f}).type(CellDesc().cellState(CellState_UnderConstruction)),
            ObjectDesc()
                .id(1)
                .pos({100.0f, 100.0f})
                .type(CellDesc()
            ...
            ObjectDesc()
                ...
                .type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
        },
        CreatureDesc().id(0),
        genome);
    data.addConnection(0, 1);
    ...
    auto data = ContentDesc().addCreature(
        {
            ...
            ObjectDesc()
                ...
                .type(CellDesc()
                          .usableEnergy(getConstructorEnergy())
                          .constructor(ConstructorDesc().geneIndex(0).lastConstructedCellId(3).separation(false).numBranches(1))),
            ObjectDesc().id(2).pos({101.0f, 100.0f}).type(CellDesc().cellState(CellState_UnderConstruction)),
            ObjectDesc()
                .id(3)
                .pos(RealVector2D{100.0f, 100.0f} + Math::unitVectorOfAngle(-45.0f) * 1.0f)
                .type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0)),
    ...
    auto data = ContentDesc().addCreature(
        {
            ...
            ObjectDesc().id(5).pos({10.0f, 9.0f - getOffspringDistance() - 1.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0).geneIndex(1)),
            ObjectDesc().id(6).pos({10.0f, 9.0f - getOffspringDistance()}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(1).geneIndex(1)),
            ObjectDesc().id(7).pos({11.0f + getOffspringDistance() + 1.0f, 10.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(0).geneIndex(1)),
            ObjectDesc().id(8).pos({11.0f + getOffspringDistance(), 10.0f}).type(CellDesc().cellState(CellState_UnderConstruction).nodeIndex(1).geneIndex(1)),
        },
        CreatureDesc().id(0),
        genome);
    data.addConnection(1, 2);
...
{
protected:
    float calcReservedEnergyToProvide(int numCellsOfReferencedGene, int numBranches, int numConcatenations) const
    {
        auto [provideEnergy, separation] = GetParam();
        if (provideEnergy != ProvideEnergy_TransitiveCells) {
            return 0.0f;
        }
        auto effectiveNumBranches = separation == Separation::Yes ? 1 : numBranches;
        return _parameters.normalCellEnergy.value[0] * toFloat(numCellsOfReferencedGene * effectiveNumBranches * numConcatenations);
    }
};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        std::make_pair(ProvideEnergy_TransitiveCells, Separation::No),
        std::make_pair(ProvideEnergy_Free, Separation::No),
        std::make_pair(ProvideEnergy_CellOnly, Separation::Yes),
        std::make_pair(ProvideEnergy_TransitiveCells, Separation::Yes),
...
TEST_P(ConstructorTests_ProvideEnergy_Separation, provideEnergy_sufficientEnergy)
{
    ...
    auto reservedEnergyToProvide = calcReservedEnergyToProvide(2, 2, 3);
    auto constructorEnergy = provideEnergy == ProvideEnergy_Free ? normalCellEnergy : normalCellEnergy * 2 + 1.0f + reservedEnergyToProvide;
    auto data = ContentDesc().addCreature(
        {
            ObjectDesc()
                .id(0)
    ...
    EXPECT_TRUE(approxCompare(reservedEnergyToProvide, getReservedEnergy(actualConstructedCell.getCellRef())));
    ...
    if (provideEnergy == ProvideEnergy_Free) {
        ...
        // Free energy is only inherited by an offspring constructor that stays within the creature or provides energy transitively
...
TEST_P(ConstructorTests_ProvideEnergy_Separation, provideEnergy_infiniteConcatenations)
{
    ...
    auto normalCellEnergy = _parameters.normalCellEnergy.value[0];
    auto reservedEnergyToProvide = calcReservedEnergyToProvide(2, 2, 1);  // Infinite concatenations count as a single one
    auto constructorEnergy = provideEnergy == ProvideEnergy_Free ? normalCellEnergy : normalCellEnergy * 2 + 1.0f + reservedEnergyToProvide;
...
TEST_F(ConstructorTests, provideEnergyForTransitiveCells_nestedConstructors)
{
    ...
    // so the cells of gene 2 have to be supplied through it.
...
TEST_F(ConstructorTests, provideEnergyForTransitiveCells_cyclicGeneReferences)
{
    ...
    // The cycle contributes nothing instead of an unbounded amount: the built constructor is supplied for the single cell of
...
TEST_F(ConstructorTests, provideEnergyForTransitiveCells_rootGeneNotSupplied)
{
    auto normalCellEnergy = _parameters.normalCellEnergy.value[0];

    // The constructor of the built cell references the root gene, which starts the genome anew and is not supplied
    auto genome = GenomeDesc().genes({
        GeneDesc().nodes({
            NodeDesc(),
...
TEST_F(ConstructorTests, provideFreeEnergy_separatingTransitiveConstructorInheritsFreeEnergy)
{
    auto genome = GenomeDesc().genes({
        GeneDesc().nodes({
            NodeDesc(),
...
TEST_F(ConstructorTests, provideFreeEnergy_rootGeneConstructorDoesNotInheritFreeEnergy)
{
    auto genome = GenomeDesc().genes({
        GeneDesc().nodes({
            NodeDesc(),
        ...
        GeneDesc().nodes({
            NodeDesc(),
            NodeDesc().constructor(ConstructorGenomeDesc().provideEnergy(ProvideEnergyGenome_TransitiveCells).geneIndex(0).separation(true)),
        }),
    });
    ...
    auto actualConstructedCell = actualData.getOtherObjectRef({0, 1});
    auto newConstructor = actualConstructedCell.getCellRef()._constructor.value();
    EXPECT_EQ(ProvideEnergy_TransitiveCells, newConstructor._provideEnergy);
    EXPECT_TRUE(approxCompare(0.0f, getReservedEnergy(actualConstructedCell.getCellRef())));
}
...
INSTANTIATE_TEST_SUITE_P(
    ConstructorTests_ProvideEnergy,
    ConstructorTests_ProvideEnergy,
    ::testing::Values(ProvideEnergy_CellOnly, ProvideEnergy_TransitiveCells, ProvideEnergy_Free));

TEST_P(ConstructorTests_ProvideEnergy, provideEnergy_constructedDepotStartsEmpty)
{
    ...
    auto constructorEnergy = provideEnergy == ProvideEnergy_Free ? normalCellEnergy : normalCellEnergy * 2 + 1.0f;
...
TEST_F(ConstructorTests, externalEnergyInflowOnlyForFirstOffspring_firstOffspring)
{
    ...
    // Construction should succeed after external energy inflow has been distributed to the constructor.
    ASSERT_EQ(2, actualData._creatures.size());
}
...
TEST_F(ConstructorTests, externalEnergyInflow_distributedProportionally)
{
    ...
    data.addCreature(
        ...
        GenomeDesc().genes({GeneDesc().nodes({NodeDesc()})}));
    data.addCreature(
        {ObjectDesc().id(1).pos({200.0f, 100.0f}).type(CellDesc().usableEnergy(normalEnergy).constructor(ConstructorDesc().geneIndex(0).separation(true)))},
        CreatureDesc().id(1),
        GenomeDesc().genes({GeneDesc().nodes({NodeDesc()})}));
