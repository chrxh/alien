...
TEST_F(TransmitterTests, distributeToOtherTransmitter)
{
    ...
    data.addCells({
        CellDescription()
            .setId(1)
            .setPos({10.0f, 10.0f})
            .setCellTypeData(DepotDescription().setMode(EnergyDistributionMode_TransmittersAndConstructors))
...
TEST_F(TransmitterTests, distributeToConnectedCells)
{
    ...
    data.addCells({
        CellDescription()
            .setId(1)
            .setPos({10.0f, 10.0f})
            .setCellTypeData(DepotDescription().setMode(EnergyDistributionMode_ConnectedCells))
            .setEnergy(_parameters.cellNormalEnergy[0] * 2),
        CellDescription()
            .setId(2)
            .setPos({11.0f, 10.0f})
...
TEST_F(TransmitterTests, distributeToOtherTransmitterAndConstructor)
{
    ...
    data.addCells({
        CellDescription()
            ...
            .setCellTypeData(DepotDescription().setMode(EnergyDistributionMode_TransmittersAndConstructors))
            .setEnergy(_parameters.cellNormalEnergy[0] * 2),
        CellDescription().setId(2).setPos({11.0f, 10.0f}).setCellTypeData(ConstructorDescription().setGenome(genome)),
        CellDescription().setId(3).setPos({9.0f, 10.0f}).setCellTypeData(DepotDescription()),
    });
    data.addConnection(1, 2);
    data.addConnection(2, 3);
...
TEST_F(TransmitterTests, distributeOnlyToActiveConstructors)
{
    ...
    data.addCells({
        ...
        CellDescription()
            .setId(2)
            .setPos({11.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setGenome(GenomeDescriptionConverterService::get().convertDescriptionToBytes(genome))),
        CellDescription().setId(3).setPos({9.0f, 10.0f}).setCellTypeData(DepotDescription()),
    });
    data.addConnection(1, 2);
    data.addConnection(2, 3);
...
TEST_F(TransmitterTests, distributeNotToNotReadyConstructors)
{
    ...
    data.addCells({
        CellDescription()
            .setId(1)
            .setPos({9.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setNumInheritedGenomeNodes(4).setGenome(GenomeDescriptionConverterService::get().convertDescriptionToBytes(genome))),
        CellDescription()
            .setId(2)
            .setPos({10.0f, 10.0f})
            .setCellTypeData(DepotDescription().setMode(EnergyDistributionMode_TransmittersAndConstructors))
        ...
        CellDescription()
            .setId(3)
            .setPos({11.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setGenome(GenomeDescriptionConverterService::get().convertDescriptionToBytes(subgenome))),
    });
    data.addConnection(1, 2);
    data.addConnection(2, 3);
