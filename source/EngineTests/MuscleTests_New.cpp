...
TEST_P(MuscleTests_AutoBending_New, autoBendingWithNumConnectionsEquals2)
{
...
TEST_P(MuscleTests_AutoBending_New, autoBendingWithNumConnectionsEquals1)
{
    auto constexpr MaxAngleDeviation = 30.0f;
    auto constexpr AnglePrecision = NEAR_ZERO;
...
TEST_P(MuscleTests_ManualBending_New, manualBendingWithNumConnectionsEquals2)
{
    auto constexpr MaxAngleDeviation = 30.0f;
    auto constexpr AnglePrecision = NEAR_ZERO;
