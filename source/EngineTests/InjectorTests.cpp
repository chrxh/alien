...
TEST_F(InjectorTests, matchButNoInjection)
{
    ...
    data.addCells(
        ...
        CellDescription()
            .setId(3)
            .setPos({9.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setNumInheritedGenomeNodes(1)),
    });
    data.addConnection(1, 2);
...
TEST_F(InjectorTests, injectOnlyEmptyCells_failed)
{
    ...
    data.addCells({
        ...
        CellDescription()
            .setId(3)
            .setPos({9.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setGenome(otherGenome).setNumInheritedGenomeNodes(2)),
    });
    data.addConnection(1, 2);
...
TEST_F(InjectorTests, injectOnlyEmptyCells_success)
{
    ...
    data.addCells({
        ...
        CellDescription()
            .setId(4)
            .setPos({7.0f, 10.0f})
            .setCellTypeData(ConstructorDescription().setNumInheritedGenomeNodes(2)),
    });
    data.addConnection(1, 2);
