...
public:
	...
	void init(NumberGenerator* numberGen, SpacePropertiesImpl* metric, CellMap* cellMap, ParticleMap* energyMap
	...
	virtual SpacePropertiesImpl* getSpaceProperties () const override;
...
private:
	...
	SpacePropertiesImpl* _spaceProperties = nullptr;
