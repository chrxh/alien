...
AlienEnergyGuidanceImpl::AlienEnergyGuidanceImpl (AlienGrid*& grid)
    : AlienEnergyGuidance(grid)
{

}

AlienCellDecorator::ProcessingResult AlienEnergyGuidanceImpl::processImpl (AlienToken* token, AlienCell* cell, AlienCell* previousCell)
{
