...
public:
	...
	virtual void init(SpaceMetric* metric, Grid* grid, ThreadController* threads, SymbolTable * symbolTable, SimulationParameters* parameters) = 0;

	virtual SpaceMetric* getTopology() const = 0;
	virtual Grid* getSimulationGrid() const = 0;
